...
si al armar el JSON te quedó una condición con ambos grupos vacíos, BORRALA del array antes de
responder, porque una condición imposible de cumplir hunde la cobertura de todo el resultado.
...
- Máximo 4 keywords_directas y 6 keywords_proxy por condición (hasta 10 proxy si directas queda vacío). Máximo 5 condiciones en total.
...
4. OCASIONES SOCIALES (CON QUIÉN va la persona: "con amigas", "con mi pareja", "con mis abuelos", "con chicos", "una juntada", "primera cita", "con mi mamá"): UNA sola condición de ambiente, salvo que el usuario haya nombrado explícitamente más de una cosa.
   Motivo: los tags de la lista TAGS DE OCASIÓN Y USO se generaron automáticamente desde reseñas y son ruidosos. Un café puede tener "merendar con amigos" porque una reseña decía "el café de mi amiga estaba quemado". Sirven para encontrar candidatos, no para afirmar que el café cumple.
   - En keywords_proxy: los términos de la lista TAGS DE OCASIÓN Y USO que correspondan a lo pedido, preferentemente en su forma más corta y todavía específica ("con amigas", "en pareja", "en familia", "con mascotas"), porque el matching es por palabra completa dentro del tag y esa forma corta encuentra todas las variantes. Si la ocasión pedida no aparece en esa lista (abuelos, chicos, ir solo), no la inventes: usá observables de ambiente.
   - En keywords_directas: SOLO formulaciones que estén en el VOCABULARIO DE AMBIENTE (la lista de 300) y sean literales de la ocasión o del clima social pedido -- ej "familiar", "ambiente familiar", "intimo". Ese vocabulario es confiable; la lista de ocasiones no. Un término que solo aparece en TAGS DE OCASIÓN Y USO NUNCA va en directas.
   - Si ningún término del VOCABULARIO DE AMBIENTE aplica, keywords_directas queda VACÍO.
   Esta regla se activa SOLO si el usuario nombró con quién va. "Un lugar romántico", "cafeterías con brunch",
...
11. Máximo 4 keywords_directas y máximo 6 keywords_proxy por condición -- hasta 10 keywords_proxy si keywords_directas quedó vacío, porque ahí los proxies son la única red disponible. Máximo 5 condiciones en total. Además del tope, keywords_directas se rige por el criterio estricto de arriba: solo formulaciones que un tag usaría, y ante la duda una menos.
...
TAGS DE OCASIÓN Y USO (del campo ideal_para de la base: con quién va la gente a cada café).
Son los únicos tags de ocasión que existen. Si una ocasión no está acá, no hay dato en la base y no la inventes.

USALOS SOLO cuando la consulta sea sobre CON QUIÉN va la persona (con amigas, con mi pareja, en familia,
con chicos, una juntada, primera cita). Si la consulta es sobre un PRODUCTO (brunch, desayuno, merienda,
medialunas), una ACTIVIDAD (leer, trabajar, estudiar) o una CUALIDAD del lugar (romántico, lindo, acogedor,
auténtico, tranquilo), NO uses estos tags ni tomes prestada su forma: "brunch en pareja" no es evidencia de
brunch, y "cita romantica" no es evidencia de que el lugar sea romántico. En esos casos la intención se
resuelve con los otros vocabularios, como venías haciendo. Una intención NO se vuelve de
ocasión porque alguna gente haga esa actividad acompañada.
La lista:
{json.dumps(vocab['ideal_para_top'], ensure_ascii=False)}
...
<head>
  ...
  !function(T,l,y){var S=T.location,k="script",D="connectionString",C="ingestionendpoint",I="disableExceptionTracking",E="ai.device.",b="toLowerCase",w="crossOrigin",N="POST",e="appInsightsSDK",t=y.name||"appInsights";(y.name||T[e])&&(T[e]=t);var n=T[t]||function(d){var g=!1,f=!1,m={initialize:!0,queue:[],sv:"5",version:2,config:d};function v(e,t){var n={},a="Browser";return n[E+"id"]=a[b](),n[E+"type"]=a,n["ai.operation.name"]=S&&S.pathname||"_unknown_",n["ai.internal.sdkVersion"]="javascript:snippet_"+(m.sv||m.version),{time:function(){var e=new Date;function t(e){var t=""+e;return 1===t.length&&(t="0"+t),t}return e.getUTCFullYear()+"-"+t(1+e.getUTCMonth())+"-"+t(e.getUTCDate())+"T"+t(e.getUTCHours())+":"+t(e.getUTCMinutes())+":"+t(e.getUTCSeconds())+"."+((e.getUTCMilliseconds()/1e3).toFixed(3)+"").slice(2,5)+"Z"}(),iKey:e,name:"Microsoft.ApplicationInsights."+e.replace(/-/g,"")+"."+t,sampleRate:100,tags:n,data:{baseData:{ver:2}}}}var h=d.url||y.src;if(h){function a(e){var t,n,a,i,r,o,s,c,u,p,l;g=!0,m.queue=[],f||(f=!0,t=h,s=function(){var e={},t=d.connectionString;if(t)for(var n=t.split(";"),a=0;a<n.length;a++){var i=n[a].split("=");2===i.length&&(e[i[0][b]()]=i[1])}if(!e[C]){var r=e.endpointsuffix,o=r?e.location:null;e[C]="https://"+(o?o+".":"")+"dc."+(r||"services.visualstudio.com")}return e}(),c=s.instrumentationkey||d.instrumentationKey||"",u=s[C],p=u?u+"/v2/track":d.endpointUrl,(l=[]).push((n="SDK LOAD Failure: Failed to load Application Insights SDK script (See stack for details)",a=t,i=p,(o=(r=v(c,"Exception")).data).baseType="ExceptionData",o.baseData.exceptions=[{typeName:"SDKLoadFailed",message:n.replace(/\./g,"-"),hasFullStack:!1,stack:n+"\nSnippet failed to load ["+a+"] -- Telemetry is disabled\nHelp Link: https://go.microsoft.com/fwlink/?linkid=2128109\nHost: "+(S&&S.pathname||"_unknown_")+"\nEndpoint: "+i,parsedStack:[]}],r)),l.push(function(e,t,n,a){var i=v(c,"Message"),r=i.data;r.baseType="MessageData";var o=r.baseData;return o.message='AI (Internal): 99 message:"'+("SDK LOAD Failure: Failed to load Application Insights SDK script (See stack for details) ("+n+")").replace(/\"/g,"")+'"',o.properties={endpoint:a},i}(0,0,t,p)),function(e,t){if(JSON){var n=T.fetch;if(n&&!y.useXhr)n(t,{method:N,body:JSON.stringify(e),mode:"cors"});else if(XMLHttpRequest){var a=new XMLHttpRequest;a.open(N,t),a.setRequestHeader("Content-type","application/json"),a.send(JSON.stringify(e))}}}(l,p))}function i(e,t){f||setTimeout(function(){!t&&m.core||a()},500)}var e=function(){var n=l.createElement(k);n.src=h;var e=y[w];return!e&&""!==e||"undefined"==n[w]||(n[w]=e),n.onload=i,n.onerror=a,n.onabort=i,l.getElementsByTagName(k)[0].parentNode.appendChild(n),n}()}try{m.cookie=l.cookie}catch(p){}function t(e){for(;e.length;)!function(t){m[t]=function(){var e=arguments;g||m.queue.push(function(){m[t].apply(m,e)})}}(e.pop())}var n="track",r="TrackPage",o="TrackEvent";t([n+"Event",n+"PageView",n+"Exception",n+"Trace",n+"DependencyData",n+"Metric",n+"PageViewPerformance","start"+r,"stop"+r,"start"+o,"stop"+o,"addTelemetryInitializer","setAuthenticatedUserContext","clearAuthenticatedUserContext","flush"]),m.SeverityLevel={Verbose:0,Information:1,Warning:2,Error:3,Critical:4};var s=(d.extensionConfig||{}).ApplicationInsightsAnalytics||{};if(!0!==d[I]&&!0!==s[I]){var c="onerror";t(["_"+c]);var u=T[c];T[c]=function(e,t,n,a,i){var r=u&&u(e,t,n,a,i);return!0!==r&&m["_"+c]({message:e,url:t,lineNumber:n,columnNumber:a,error:i}),r},d.autoExceptionInstrumented=!0}return m}(y.cfg);function a(){y.onInit&&y.onInit(n)}(T[t]=n).queue&&0===n.queue.length?(n.queue.push(a),n.trackPageView({})):a()}(window,document,{
  ...
  cfg:{
      ...
      correlationHeaderExcludedDomains: ["*.queue.core.windows.net", "*.blob.core.windows.net", "plausible.io", "www.gstatic.com", "*.googleapis.com", "*.firebaseio.com"]
  }});
  </script>
